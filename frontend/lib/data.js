...
export const REVIEWS = {
  fr: [
    ...
    { avatar:'🥣',   name:'Yousra B.', role:'Fondatrice, Granola Ya Salam',   stars:5,
  ...
  en: [
    ...
    { avatar:'🥣',   name:'Yousra B.', role:'Founder, Granola Ya Salam',      stars:5,
  ...
  ar: [
    ...
    { avatar:'🥣',   name:'يسرا ب.',  role:'مؤسسة، Granola Ya Salam',          stars:5,
