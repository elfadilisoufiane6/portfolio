...
export default function ProjectsRenderer({ imagesBySlug }) {
  ...
  const closeLb = () => setLb((s) => ({ ...s, idx: null }));
  ...
  return (
    <>
            ...
            <div className="container">
              <div className="project-grid">
                <Reveal variant={isEven ? 'right' : 'left'} as="div" className="project-info">
                  ...
                  <a href={waLink(p.waMsg)} className="btn-wa" target="_blank" rel="noopener noreferrer">
      ...
      <Lightbox images={lb.images} openIdx={lb.idx} onClose={closeLb} />
    </>
  );
}
